...
from .const import (
    CONF_NAME, CONF_NOTIFY, CONF_NOTIFY_ON, CONF_NOTIFY_TIME, CONF_NOTIFY_URL, CONF_PLANTS, DEFAULT_ICON,
    DEFAULT_INTERVAL, DEFAULTS, DOMAIN, P_ICON, P_ID, P_INTERVAL, P_LAST, P_LATIN, P_NAME, P_TIP,
)
